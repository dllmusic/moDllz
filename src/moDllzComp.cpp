...
//	paramLCD::drawLayer( args, layer);
//}
//void MPEYdetuneLCD::onButton(const event::Button &e) {
//	if ((e.button != GLFW_MOUSE_BUTTON_LEFT) || !(*canedit) || (e.action != GLFW_PRESS)) return;
//	buttonIdMap =  (*polyModeId_val < polyModePoly)? &buttonId : &buttonId2;
//	if (*cursorIx != *buttonIdMap){
//		*cursorIx = *buttonIdMap;
//		*updateKnob = true;
//		flashFocus = 80;
//		if(canlearn) *learnId = *buttonIdMap;//learnId;
//	}else{
//		*onFocus = 1;// next goes to 0
//	}
//}
