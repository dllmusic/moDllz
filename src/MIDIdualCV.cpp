...
MIDIdualCVWidget::MIDIdualCVWidget()
{
    ...
    //Retrig Switches
    addParam(createParam<CKSS>(Vec(24, yPos+1), module, MIDIdualCVInterface::LWRRETRGGMODE_PARAM, 0.0, 1.0, 1.0));
    addParam(createParam<CKSS>(Vec(98, yPos+1), module, MIDIdualCVInterface::UPRRETRGGMODE_PARAM, 0.0, 1.0, 1.0));
    yPos += 34;
    xPos = 88;
    //Common Outputs
    for (int i = 0; i < 4; i++)
